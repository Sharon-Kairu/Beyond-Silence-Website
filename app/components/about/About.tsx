...
const About = () => {
  ...
  <div className='mt-6 mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10 items-center'>
    ...
    <div className='flex flex-col justify-center'>
      <p className='m-6 text-gray-800 text-lg leading-relaxed'>
        Founded in July 2025, Beyond Silence is a community dedicated to mental wellness and support.
        We provide a safe space for individuals to share their thoughts and experiences openly.
        Our mission is to listen, empower, and connect people facing emotional challenges.
        Through compassionate dialogue and guided resources, we foster personal growth and healing.
        We believe every voice matters and every story deserves to be heard without judgment.
        Our team of volunteers and experts work together to create a nurturing environment.
        Join us in building a community where understanding, support, and hope thrive.
      </p>
    </div>
